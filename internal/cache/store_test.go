...
func testMessages() []api.Message {
	return []api.Message{
		{Role: "user", Content: "What is 2+2?"},
	}
}

func testResponse() *api.ChatCompletionResponse {
	return &api.ChatCompletionResponse{
		...
		Model:   "gpt-4.1-nano",
		Choices: []api.Choice{
			{Index: 0, Message: &api.Message{Role: "assistant", Content: "4"}},
		},
	}
}
...
func TestVectorStore_Insert(t *testing.T) {
	...
	var cached api.ChatCompletionResponse
