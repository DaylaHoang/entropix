	...
	chunks := []api.StreamChunk{
		{
			...
			Choices: []api.Choice{{Index: 0, Delta: &api.Delta{Content: "Hello"}}},
		},
		{
			ID: "chunk-2", Object: "chat.completion.chunk", Model: "llama3-8b-8192",
			Choices: []api.Choice{{Index: 0, Delta: &api.Delta{Content: " world"}}},
		},
		{
			ID: "chunk-3", Object: "chat.completion.chunk", Model: "llama3-8b-8192",
			Choices: []api.Choice{{Index: 0, Delta: &api.Delta{Content: "!"}, FinishReason: &finish}},
		},
	}
...
func TestAssembleResponse_NilDelta(t *testing.T) {
	chunks := []api.StreamChunk{
		{
			ID: "chunk-1", Object: "chat.completion.chunk", Model: "llama3-8b-8192",
			Choices: []api.Choice{{Index: 0, Delta: &api.Delta{Role: "assistant"}}},
		},
		{
			ID: "chunk-2", Object: "chat.completion.chunk", Model: "llama3-8b-8192",
			Choices: []api.Choice{{Index: 0, Delta: &api.Delta{Content: "Hi"}}},
		},
	}
