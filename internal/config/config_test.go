...
func TestLoad_Defaults(t *testing.T) {
	...
	if cfg.Speculative.Enabled != nil {
		t.Error("default parallel.enabled should be nil (unset)")
	}
	if cfg.Speculative.SoftThresholdMult != 0.8 {
		t.Errorf("default parallel.soft_threshold_mult: got %f, want 0.8", cfg.Speculative.SoftThresholdMult)
	}
}
...
func TestLoad_CacheDefaults(t *testing.T) {
	...
	if cfg.Cache.QdrantCollection != "entropix_cache" {
